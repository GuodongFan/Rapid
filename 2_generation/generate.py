    ...
    def generate(self, 
        ...
        for start_idx in trange(0, len(corpus), batch_size, desc='pas'):
            ...
            for idx in range(size):      
                ...
                #_, query_set = selectBest(list(query_set))
                #query_set = query_set[0:ques_per_passage]
                #query_set = set(query_set.tolist())
                #for query in query_set:
                #    print(query)
                #    print(pchecker.perplexity(text_formatter(query)))
